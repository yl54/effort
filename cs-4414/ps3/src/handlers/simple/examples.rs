...
pub fn handle_default(stream: TcpStream) {
    ...
    // Write to stream.
    write_response(html_file_path, stream);
}
...
fn write_response(file_path: &str, stream: TcpStream) {
